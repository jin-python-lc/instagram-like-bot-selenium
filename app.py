...
list = [1,12,13,14]
arg = random.choice(list)
args = arg
#コマンドの引数
####################設定####################

#１日にいいね！できる最大値。この数を超えたら処理終了
max_limit_likes_counter = 299

#自動いいね！時、エラーがこの数を超えたら処理終了
max_limit_error_cnt = 9

#1ハッシュタグにつき何投稿にいいねするか
like_per_one_tag = 29
...
#読み込みファイル名
file_words = "words_" + str(args) +".txt"
#file_words = "words_" + str(1) +".txt"
...
for word in words:
    ...
    #ハッシュタグ１つにつき何投稿いいねするか
    hrefList = hrefList[:like_per_one_tag]
